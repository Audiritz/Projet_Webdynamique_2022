...
<body>
    ...
    <div id="wrapper4admin">
        <div class="admin">
            <h2 class="display-4">Compte Administrateur</h2>
            <p class="lead">Nom</p>
            <p class="lead">Prenom</p>
            <hr class="my-4">
            <p>Mail</p>
            <p class="lead">
                <a class="btn btn-primary btn-lg" href="http://localhost/Projet_Web/CreerCoach.php" role="button">Ajouter Coach</a>
                <a class="btn btn-primary btn-lg" href="http://localhost/Projet_Web/SuppCoach.php" role="button">Supprimer Coach</a>
            </p>
        </div>
    </div>
