        ...
        <div class="coach-grid">
            ...
            <div class="description-grid">
                ...
                <div class="button-grid">
                    <div class="button">
                        <a href="CV-fitness.php" class="text-button">Voir CV</a>
                    </div>
                    <div class="button">
                        <a href="pcreerRdv" class="text-button">Prendre rendez-vous</a>
                    </div>
                    <div class="button">
